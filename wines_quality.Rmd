...
'The sign is negative, meaning that, in our data, wines with a greater alcohol percentage are likely to be of lower quality.'
...
The following variables are those significant at a 99.99% confidence level:\
  * "Intercept": the value 0.01855% corresponds to the odds of having a high quality wine when all the explanatory variables are set to 0.
  * "fixed.acidity": a unitary increase (1 g/dm^3) in fixed acidity will lead to a 81.93% increase in the odds of having a high quality wine.
  * "volatile.acidity": a unitary increase (1 g/dm^3) in volatile acidity will lead to a 10.70% increase in the odds of having a high quality wine.
  * "residual.sugar": a unitary increase (1 g/dm^3) in residual sugar will lead to a 107.20% increase in the odds of having a high quality wine.
  * "free.sulfur.dioxide": a unitary increase (1 mg/dm^3) in free sulfur dioxide will lead to a 100.92% increase in the odds of having a high quality wine.
  * "alcohol": a unitary increase (percentage) in alcohol will lead to a 296.73% increase in the odds of having a high quality wine.

The following variable is significant at a 99.9% confidence level:\
  * "sulphates": a unitary increase (1 g/dm^3) in sulphates will lead to a 323.72% increase in the odds of having a high quality wine.
...
```
We can state that:
  * the model predicts wines quality with 71.55% accuracy.
...
```{r}
dtrain_of <- dtrain.res %>% filter(id != "4481")
